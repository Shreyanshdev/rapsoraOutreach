...
function HomeContent() {
  ...
  return (
    <div className="flex h-screen bg-[#050507] text-zinc-100 font-sans overflow-hidden relative">
      ...
      <main className={`flex-1 relative flex flex-col ${activeTab === "inbox" || activeTab === "send" ? "overflow-hidden" : "overflow-y-auto"}`}>
        {/* Mobile Header */}
        ...
        <div className={`flex-1 ${activeTab === "inbox" || activeTab === "send" ? "min-h-0 flex flex-col" : ""}`}>
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`max-w-7xl mx-auto ${activeTab === "inbox" || activeTab === "send" ? "flex-1 min-h-0 flex flex-col p-6 md:p-8 lg:p-12 w-full" : "p-6 md:p-12 lg:p-20"}`}
            >
